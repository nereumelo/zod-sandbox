...
export const darkTheme: CustomFlowbiteTheme = {
  button: {
    ...
    "color": {
      ...
      "info": "text-white bg-cyan-700 border border-transparent enabled:hover:bg-cyan-800 focus:ring-2 focus:ring-cyan-300 dark:bg-gray-700 dark:enabled:hover:bg-gray-800 dark:focus:ring-gray-900",
